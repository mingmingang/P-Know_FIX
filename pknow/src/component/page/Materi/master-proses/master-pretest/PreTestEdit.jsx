...
export default function MasterPreTestEdit({ onChangePage, withID }) {
    ...
    const handleAdd = async (e) => {
            ...
            if (question.type === "Pilgan" && question.options) {
                return (
                    ...
                    question.options.reduce(
                        (optionTotal, option) =>
                            optionTotal + parseInt(option.point || 0, 10),
                        0
                    )
                );
            }
        ...
        console.log("Mengirim data ke API:", quizPayload);
                    ...
                    {hasTest ? (
                      ...
                      />
                          ...
                          <Alert type="warning" message={(
                            <span>
                              Pre-Test belum ditambahkan. <a onClick={() => onChangePage("pretestEditNot", AppContext_master.MateriForm = AppContext_test.DetailMateriEdit)} className="text-primary">Tambah Data</a>
                            </span>
                          )} />
                          </div>
                            <div className="d-flex justify-content-between ">

  ...
  return (
    <div className={`card card-program mt-3 ${isContentVisible ? "border-primary" : ""}`}>
      <div className={`card-body d-flex justify-content-between ${isContentVisible ? "align-items-center border-bottom border-primary" : ""}`}>
        <div className="">
        <p className="fw-medium mb-0" style={{ width: "40%", background:"#ABCCFF", padding:"5px 10px", borderRadius:"5px" }}>
      ...
      {isContentVisible && (
        <>
         <div className="">
         <p className="ml-3 mt-4" style={{color:"#0A5EA8", fontWeight:"600", margin:"10px 0px"}}>Daftar Kategori Program</p>
         </div>
